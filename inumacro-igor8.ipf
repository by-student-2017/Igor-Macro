...
End
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        Label left "Seebeck Coefficient, \\f02S\\f00 (µ\\F'Arial'V/K\\M\\F'Arial')"
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        ModifyGraph fSize(left)=20
        ModifyGraph width=283.465
        Label left "Electrical Resistivity, \\f02ρ\\f00\\F'Arial' (µΩ\\F'Arial'cm\\M\\F'Arial')"
        ModifyGraph lblPosMode(left)=3,lblPos(left)=65
        ModifyGraph margin(left)=71
        ModifyGraph margin(right)=21
        SetAxis left 0,600
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        ModifyGraph fSize(left)=20
        ModifyGraph width=283.465
        Label left "Thermal Conductivity, \\f02κ\\F'Arial'\\f00 (W/mK)"
        ...
        //
        TextBox/C/N=text3/F=0/M/H=18/A=MC "\\M\\F'Arial'\\Z18κ\\B\\F'Arial'\\M\\F'Arial'\\Z18"
        TextBox/C/N=text2/F=0/M/H=18/A=MC "\\M\\F'Arial'\\Z18κ\\B\\F'Arial'el\\M\\F'Arial'\\Z18"
        TextBox/C/N=text1/F=0/M/H=18/A=MC "\\M\\F'Arial'\\Z18κ\\B\\F'Arial'ph\\M\\F'Arial'\\Z18"
        //
...
//
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        ModifyGraph fSize(left)=20
        ModifyGraph width=283.465
        Label left "Seebeck Coefficient, \\f02S /\\f00 µ\\Μ\\F'Times New Roman'VK\\S-1\\M\\F'Times New Roman'"
        ModifyGraph lblPosMode(left)=3,lblPos(left)=65
        ModifyGraph margin(left)=71
        ModifyGraph margin(right)=21
        SetAxis left 0,100
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        ModifyGraph fSize(left)=20
        ModifyGraph width=283.465
        //Label left "Electrical Resistivity, \\f02ρ\\f00\\Μ\\F'Times New Roman' (µΩ\\F'Times New Roman'cm\\M\\F'Times New Roman')"
        Label left "Electrical Resistivity, \\f02ρ\\f00\\Μ\\F'Times New Roman' / µΩ\\F'Times New Roman'cm\\M\\F'Times New Roman'"
        ModifyGraph lblPosMode(left)=3,lblPos(left)=65
        ModifyGraph margin(left)=71
        ModifyGraph margin(right)=21
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        ModifyGraph fSize(left)=20
        ModifyGraph width=283.465
        //Label left "Thermal Conductivity, \\f02κ\\F'Times New Roman'\\f00 (W/mK)"
        Label left "Thermal Conductivity, \\f02κ\\F'Times New Roman'\\f00 / Wm\\S-1\\MK\\S-1\\M"
        ModifyGraph lblPosMode(left)=3,lblPos(left)=55
        ModifyGraph margin(left)=71
        ModifyGraph margin(right)=21
        SetAxis left 0,12
        ...
        Legend/C/N=text0/F=0/M/H=18/A=MC
        //
        TextBox/C/N=text3/F=0/M/H=18/A=MC "\\M\\F'Times New Roman'\\Z18κ\\B\\F'Times New Roman'\\M\\F'Times New Roman'\\Z18"
        TextBox/C/N=text2/F=0/M/H=18/A=MC "\\M\\F'Times New Roman'\\Z18κ\\B\\F'Times New Roman'el\\M\\F'Times New Roman'\\Z18"
        TextBox/C/N=text1/F=0/M/H=18/A=MC "\\M\\F'Times New Roman'\\Z18κ\\B\\F'Times New Roman'ph\\M\\F'Times New Roman'\\Z18"
        //
 ...
 switch( ba.eventCode )
       case 2: // mouse up
        ...
        Label bottom "2θ\\F'Arial' (degree)"
        ModifyGraph mode=0
        break
       case -1: // control being killed
        break
